...
__author__   = '\033[1;36mClownSaw'
__instagram__ = '\033[1;36m@Clown_Saw'
__twitter__  = '\033[1;36m@Clown_Saw'
__version__  = '2.0.4'
__year__     = '2020-2021'
__web__ = '\033[1;36mwww.clownsaw.tk'
__lok__ = '\033[0;31m[\033[0;34m+\033[0;31m]'
...
▀▀▀.▀       .▀▀▀  ▀█▄▀▪·▀▀▀  ▀  ▀ .▀▀▀ ▀▀▀·▀▀▀ • ▀  ▀ ·▀▀▀ ▀▀▀ ▀█▄▀▪▀▀ █▪
  ...
  {7} By: {3}  {7} Web: {6}  {7} Twitter: {5}
""".format(Red('IPGeolocation ' + __version__), Red('['), __year__, __author__, __twitter__,__instagram__,__web__,__lok__)
